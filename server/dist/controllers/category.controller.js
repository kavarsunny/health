...
exports.getCategories = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    res.json(new ApiResponse_1.ApiResponse(true, 'Categories retrieved', data));
});
exports.createCategory = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    res.status(201).json(new ApiResponse_1.ApiResponse(true, 'Category created', data));
});
exports.deleteCategory = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    await categoryService.deleteCategory(req.params.id);
    res.json(new ApiResponse_1.ApiResponse(true, 'Category deleted', null));
});
